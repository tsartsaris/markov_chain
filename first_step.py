...
camera_lookup = {
    ...
    2 : { 'B' : 0.5 , 'A' : 0.2 , 'C' : 0.2 , 'D' : 0.1}, # στην t1 η camera λέει (2,1)
    3 : { 'D' : 0.5 , 'C' : 0.2 , 'A' : 0.2 , 'B' : 0.1}, # στην t1 η camera λέει (2,2)
    4 : { 'D' : 0.5 , 'C' : 0.2 , 'A' : 0.2 , 'B' : 0.1}  # στην t1 η camera λέει (2,2)
}
